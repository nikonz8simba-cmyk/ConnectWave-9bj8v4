      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.avatarSection}>
          <View style={styles.avatarWrapper}>
            <Avatar uri={currentUser.avatar} size={82} />
          ...
          <View style={styles.headerRight}>
            ...
            >
              <Text style={[styles.followBtnText, following ? styles.followingBtnText : null]}>
                {following ? 'Siguiendo' : 'Editar perfil'}
              </Text>
            </Pressable>
        ...
        <View style={styles.userInfo}>
          ...
          <View style={styles.metaRow}>
            ...
            <Text style={styles.metaText}>Unido en agosto 2024</Text>
          </View>
        </View>

        {/* Stats */}
        <View style={styles.statsRow}>
          <StatItem value={formatStat(currentUser.posts + myPosts.length)} label="Posts" />
          <View style={styles.statDivider} />
          <StatItem value={formatStat(currentUser.followers)} label="Seguidores" />
          <View style={styles.statDivider} />
          <StatItem value={formatStat(currentUser.following)} label="Siguiendo" />
        </View>
        ...
        <View style={styles.gridContainer}>
          {activeTab === 'posts' && myPosts.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtitle}>Crea tu primer post y comparte tu onda 🌊</Text>
            </View>
          ) : (
            <View style={styles.grid}>
              {POST_IMAGES.slice(0, activeTab === 'liked' ? 4 : 9).map((uri, idx) => (
